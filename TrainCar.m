% Wrapper to train the Algorithm for Car Paths
...
disp('Training procedure for Car Path Planner....');
...
CostMap = exp(CostMap);
CostMap = (CostMap-min(min(CostMap)))+MinValue;
save('CarModel.mat','CostMap','WtsAll','Wts','F');
disp('Model saved as CarModel.mat');